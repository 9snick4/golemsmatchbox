...
$this->gem_card_types = array(
  1 => array(
    'gems' => 3,
    'points' => 0,
    'description' => clienttranslate('Receive 3 Gems.' ) ),
  2 => array(
    'gems' => 2,
    'points' => 1,
    'description' => clienttranslate('Receive 2 Gems immediately and 1 point at the end of the game.') ),
  3 => array(
    'gems' => 1,
    'points' => 2,
    'description' => clienttranslate('Receive 1 Gem immediately and 2 points at the end of the game.') ),
  4 => array(
    'gems' => 1,
    'points' => 0,
    'description' => clienttranslate('Receive 1 Gem immediately and take another turn.') ),
  5 => array(
    'gems' => 1,
    'points' => 0,
    'description' => clienttranslate('Receive 1 Gem immediately.In this turn, you take 6 cards from the grid instead of 5.') ),
  6 => array(
    'gems' => 2,
    'points' => 0,
    'description' => clienttranslate('Receive 2 Gems immediately. When summoning a Golem you can use this card as any resource, by discarding it from the game.') ),
  7 => array(
    'gems' => 1,
    'points' => 0,
    'description' => clienttranslate('Receive 1 Gem immediately. Whenever you get both cards with this symbol you must take, in hand, the 2 cards discarded at the beginning of the game. Discard one and use the other at no cost.') ),
  8 => array(
    'gems' => 1,
    'points' => 0,
    'description' => clienttranslate('Receive 1 Gem immediately. Whenever you get both cards with this symbol you must take, in hand, the 2 cards discarded at the beginning of the game. Discard one and use the other at no cost.') )
...
$this->rune_card_types = array (
  ...
  1 => array (
    'points' => 2,
    'points_max' => 8,
    'name' => clienttranslate('Master of the Elements'),
    'description' => clienttranslate('Receive 2 points for each Summoned Golem of the corresponding type. You can receive a maximum of 8 points for the Time Golem.') ),
  //Blue
  2 => array (
    'points' => 2,
    'points_max' => 99,
  ...
  6 => array (
    'points' => 7,
    'points_max' => 7,
    'name' => clienttranslate('Master Summoner'),
    'description' => clienttranslate('Receive 7 points if you have Summoned Golems of at least 4 different types.') ),
  7 => array (
    'points' => 1,
    'points_max' => 99,
    'name' => clienttranslate('Master of the Keeper'),
    'description' => clienttranslate('Receive 1 point for each Gem in your reserve.') ),
  8 => array (
    'points' => 2,
    'points_max' => 6,
    'name' => clienttranslate('Master of the Gems'),
    'description' => clienttranslate('Receive 2 points for each Gem card in your hand. You can receive a maximum of 6 points.') ),
  9 => array (
    'points' => 1,
    'points_max' => 6,
    'name' => clienttranslate('Master of the Resources'),
    'description' => clienttranslate('Receive 1 point for each of your unused resources. You can receive a maximum of 6 points.') )
);
