 ...
 * -----
 * 
 * golemsmatchbox.action.php
 *
 * GolemsMatchbox main action entry point
 *
 *
 ...
 */
  ...
  class action_golemsmatchbox extends APP_GameAction
  { 
    // Constructor: please do not modify
   	public function __default()
  	{
  	    ...
  	    {
            $this->view = "golemsmatchbox_golemsmatchbox";
